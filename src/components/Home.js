      ...
      <div className='w-[80%] mx-auto flex md:flex-row flex-col'>
        ...
        <div className='md:w-1/2 w-full md:pr-4 pr-0 py-4'>
          ...
          <div className='w-[85%] py-2 font-medium font-ubuntu'>
            <ul className='flex flex-col gap-3 text-sm'>
              <li>Lorem ipsum dolor sit amet consectetur. Ridiculus duis id amet eu.</li>
              <li>Lorem ipsum dolor sit amet consectetur. Ridiculus duis id amet eu.</li>
              <li>Lorem ipsum dolor sit amet consectetur. Ridiculus duis id amet eu.</li>
              <li>Lorem ipsum dolor sit amet consectetur. Ridiculus duis id amet eu.</li>
              <li>Lorem ipsum dolor sit amet consectetur. Ridiculus duis id amet eu.</li>
        ...
        <div className='md:w-1/2 w-full md:pl-4 pl-0 py-4'>
          ...
          <SwiperSlide>
            <div className='flex flex-row justify-around gap-2'>
              <div className='flex flex-col gap-2'>
                <img src={event1} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
              ...
              <div className='flex flex-col gap-2'>
                <img src={event2} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
              ...
              <div className='flex flex-col gap-2'>
                <img src={event3} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
          ...
          <SwiperSlide>
            <div className='flex flex-row justify-around gap-2'>
              <div className='flex flex-col gap-2'>
                <img src={event4} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
              ...
              <div className='flex flex-col gap-2'>
                <img src={event5} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
              ...
              <div className='flex flex-col gap-2'>
                <img src={event6} alt='event1' className='lg:h-32 lg:w-32 h-24 w-24 rounded-lg'/>
